  ...
  return (
    <div>
      ...
      <div className=' flex flex-row  justify-between w-screen h-24 bg-neutral-950'>
        <div className='left text-red-500 font-bold  text-6xl top-5 left-10 relative '>
          <p className='text-white'>
            <span className='text-yellow-500'>X</span> -track
          </p>
        </div>
        ...
        <div className='flex flex-row justify-end w-1/3'>
          <div className='pl-4 mr-16 pr-4 w-auto  rounded-xl mt-6 mb-6 '>
            ...
            >
              <div className='absolute transitiona-all duration-700 opacity-70 inset-16 bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] rounded-xl blur-lg group-hover:opacity-100 group-hover:inset-1 group-hover:duration-200 animate-tilt'></div>
              <div
                title=''
                ...
                >
                  ...
                  <div className='flex flex-row gap-3 justify-between '>
                    ...
                    <button
                      ...
                      className=' rounded-xl w-fit  bg-neutral-800 p-3 text-2xl text-white'
                    >
